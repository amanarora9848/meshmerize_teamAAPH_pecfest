...
int readline(){
  ...
  int v;
  v = (4000*a[0] + 3000*a[1] + 2000*a[2] + 1000*a[1] + 0*a[0])/(a[0] + a[1] + a[2] + a[3] + a[4]);
  Serial.println(a[4]);
  return v;
}
...
char select_turn(unsigned_char found_left, unsigned_char found_right, unsigned_char found_straight){
